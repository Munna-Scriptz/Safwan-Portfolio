        ...
        <section id='Service' className='lg:mt-[252px] mt-[110px]'>
            <div className="container">
                <div id="Header" className='flex items-center justify-center flex-col gap-[24px]'>
                    <p className='font-vollkorn font-medium text-[18px] text-[#EF8100]' data-aos="fade-up">SERVICE</p>
                    <p className='font-vollkorn font-medium lg:text-[50px] text-[42px] text-primary lg:w-[475px] w-full text-center' data-aos="fade-up">09+ Years Experience in This Field</p>
                </div>
                {/* -------------Cards------------- */}
                <div id='Cards' className='mt-[40px] flex lg:flex-row flex-col items-center gap-[30px] justify-center'>
                    <div className='lg:w-[410px] w-full bg-white lg:p-[50px] p-[20px]' data-aos="fade-up">
