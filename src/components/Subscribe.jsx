...
const Subscribe = () => {
  return (
    <>
        <section id='Subscribe' className='mt-[140px] overflow-hidden'>
            <div className="container">
                <div id="SubRow" className='bg-[#E5745D] py-[36px] lg:px-[60px] px-5 flex lg:flex-row lg:gap-0 gap-5 flex-col items-center justify-between'>
                    <div>
                        <h2 className='font-vollkorn font-bold text-white lg:text-[40px] text-[25px]' data-aos="fade-right">Subscribe to our Youtube!</h2>
                        <p className='font-jost lg:w-[483px] w-full font-normal leading-[26px] text-white lg:text-[18px] text-[14px]' data-aos="fade-right">Please like and subscribe to my channel and press the bell icon to get new video updates.</p>
                    </div>
                    <div className='flex lg:flex-row flex-col items-center gap-[10px]' data-aos="fade-left">
