...
const ResNavbar = () => {
  ...
  return (
    <>
        <nav className='relative py-[20px] border-[1px] z-20 border-[#D3DCD4] lg:hidden'>
            <div className="container overflow-hidden">
                <div id="NavRow" className='flex items-center justify-between'>
                    {/* ------Nav Img----- */}
                    <Link data-aos="fade-down" data-aos-easing="ease-in-sine" data-aos-duration="1800" data-aos-delay="200" to={'/'}><img src={Logo} alt="Logo" /></Link>
                    {/* ------Nav Buttons----- */}
                    <div className='flex items-center gap-[25px] text-[21px] text-primary'>
                        <button className='hover:text-[#E5745D] duration-[.3s] cursor-pointer' data-aos="fade-down" data-aos-easing="ease-in-sine" data-aos-duration="1800" data-aos-delay="400"><FiSearch /></button>
                        <span className='w-[1px] h-[20px] bg-primary' data-aos="fade-down" data-aos-easing="ease-in-sine" data-aos-duration="1800" data-aos-delay="500"></span>
                        <button className='hover:text-[#E5745D] duration-[.3s] cursor-pointer' onClick={()=>setMenu(!menu)} data-aos="fade-down" data-aos-easing="ease-in-sine" data-aos-duration="1800" data-aos-delay="600"><HiMiniBars3BottomRight /></button>
                    </div>
                    {/* -----Nav Links----- */}
