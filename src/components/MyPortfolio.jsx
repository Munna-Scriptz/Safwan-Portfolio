            ...
            <section className='lg:mt-[240px] mt-[75px] pb-19'>
                <div className="container">
                    <div id="TextHeader" className='mb-[40px]'>
                        <h2 className='font-vollkorn font-medium text-[50px] text-primary text-center' data-aos="fade-up">My Working Portfolio</h2>
                    </div>
                </div>
                <div id="projectShow" className='flex lg:flex-row flex-col gap-[29px] justify-center lg:px-0 px-[16px]'>
                        ...
                        <div className='flex flex-col gap-[29px] lg:mt-[120px]'>
                            <div className='lg:w-[420px] w-full h-[400px] outline-1 outline-[#00413D] flex items-center justify-center p-[20px]' data-aos="fade-up">
                                <div className='w-full h-full bg-[#C4C4C4]'>

                                </div>
                            </div>
                            <div className='lg:w-[420px] w-full lg:h-[600px] h-[500px] outline-1 outline-[#00413D] flex items-center justify-center p-[20px]' data-aos="fade-up">
                                <div className='w-full h-full bg-[#C4C4C4]'>
                        ...
                        <div className='flex flex-col gap-[29px] lg:mt-[40px]'>
                            <div className='relative lg:w-[420px] w-full lg:h-[600px] h-[500px] outline-1 outline-[#00413D] flex items-center justify-center p-[20px]' data-aos="fade-up">
                                <div className='w-full h-full bg-[#C4C4C4]'>
                ...
                <div id="TextBottom" className='lg:mt-[109px] mt-[71px] flex items-center justify-center' data-aos="fade-up">
